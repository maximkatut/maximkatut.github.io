  ...
  return (
    <section className="about">
      ...
      <div className="about__description">
        ...
        States 🇺🇸. I am Front-end developer with a strong passion of React. Each
        day I learn something new and create web products using best practices
        and modern techhologies.
